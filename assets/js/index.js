                ...
                if(device.kind === 'videoinput'){
                    if(device.label.includes('')){//ATIV VGA Camera and DEMO1
                        navigator.getUserMedia(
                            ...
                            stream => cam.srcObject = stream,//função de callback
...
cam.addEventListener('play', async () =>{
    ...
    setInterval(async () => {
        ...
        .withFaceLandmarks()// criar um quadrado fica detectando a face
        .withFaceExpressions()//teste expressões faciais
        .withAgeAndGender() // A idade da pessoa
        .withFaceDescriptors()
